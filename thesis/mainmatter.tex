...
% The goal aimed when studying diagonalization of quaternion matrices is to enable and enlighten the spectral analysis of graph shift operators in graphs with quaternion-valued edge weights. In this case, the eigenvalues play the role of graph frequencies and, as such, it is important to be able to sort them from lowest to highest frequencies.
