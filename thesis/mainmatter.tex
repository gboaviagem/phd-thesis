...
\begin{figure}
	\centering
	\includegraphics[width=0.75\linewidth]{thesis/Figures/us_counties_graph.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\linewidth]{thesis/Figures/us_counties_qgsp_tv1.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\linewidth]{thesis/Figures/us_counties_qgsp_tv.pdf}
	\caption{Eigenvalues of the quaternion graph adjacency matrix, shown in the complex plane. The pseudo-colorscale indicates the respective eigenvectors total variation.}
