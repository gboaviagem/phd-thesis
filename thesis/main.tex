...
% ---
\titulo{Foundations of quaternion graph signal processing and related contributions on fractional-order operators}
...
\preambulo{This work was presented to the Electrical Engineering Postgraduate Program, at the Technology and Geoscience Center of the Federal University of Pernambuco, as a partial requisite to obtaining a doctorate degree on Electrical Engineering.
}
% ---
...
\end{aligned}
\end{equation}
Consequently, since $ \qj x = \overline{x} \qj $, so (\ref{eq:A5}) equals
\begin{equation}
\begin{aligned}
\label{eq:A7}
