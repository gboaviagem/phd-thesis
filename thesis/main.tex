...
% ---
\titulo{Contribui\c c\~oes para o processamento de sinais quaterni\^onicos: aspectos te\'oricos e aplica\c c\~oes}
...
\preambulo{Trabalho apresentado ao Programa de P\'os-gradua\c c\~ao em Engenharia El\'etrica do Centro de Tecnologia e Geoci\^encias da Universidade Federal de Pernambuco como requisito parcial para obten\c c\~ao do grau de Doutor em Engenharia El\'etrica.
}
% ---
...
% ---
%\begin{siglas}
%\item[QFT] \emph{Quaternion Fourier Transform}, Transformada de Fourier Quaterni\^onica
%\item[MFrQDFT] \emph{Multi-parametric Fractional Quaternion Discrete Fourier Transform}, Transformada Multiparam\'etrica Discreta de Fourier Quaterni\^onica
%\item[GSP] \emph{Graph Signal Processing}, Processamento de Sinais sobre Grafos
%\item[QGSP] \emph{Quaternion Graph Signal Processing}, Processamento de Sinais sobre Grafos Quaterni\^onicos
%\end{siglas}
% ---
