...
\usepackage{textcomp,color,enumerate}
...
\title{On the Fractionalization of the Shift Operator on Graphs}

\author{\uppercase{Guilherme B. Ribeiro\authorrefmark{1}, Jos\'e R. de Oliveira Neto\authorrefmark{2}}, (Member, IEEE), \uppercase{and Juliano B. Lima\authorrefmark{1}}, (Senior Member, IEEE)}

\address[1]{Department of Electronics and Systems, Federal University of Pernambuco, Recife 50740-550, Brazil}

\address[2]{Department of Mechanical Engineering, Federal University of Pernambuco, Recife 50740-550, Brazil}

\tfootnote{This work was supported in part by Conselho Nacional de Desenvolvimento Científico e Tecnológico (CNPq) under grants 310142/2020-2 and 409543/2018-7, and by Coordena\c{c}\~ao de Aperfei\c{c}oamento de Pessoal de N\'ivel Superior (CAPES).}

\markboth
{Ribeiro \headeretal: On the Fractionalization of the Shift Operator on Graphs}
{Ribeiro \headeretal: On the Fractionalization of the Shift Operator on Graphs}

\corresp{Corresponding author: Juliano B. Lima (e-mail: juliano\_bandeira@ieee.org).}
...
\begin{keywords}
Graph signal processing, fractional graph shift operator, graph filter design, noise removal.
\end{keywords}
...
%\begin{figure}%
%	\centering
%	\subfloat[\label{figa_graphs}]{{\includegraphics[width=0.45\linewidth]{Figuras/signal_ring_graph_white_border.pdf} }}\hspace{0.2cm}%
%	\qquad
%	\subfloat[t][\label{figb_graphs}]{{\includegraphics[width=0.4\linewidth]{Figuras/signal_duher_graph.pdf} }}\\
%	\subfloat[\label{figc_graphs}]{{\includegraphics[width=0.45\linewidth]{Figuras/image_graph.pdf} }}%
%	\subfloat[\label{figd_graphs}]{{\includegraphics[width=0.4\linewidth]{Figuras/graph_temp_bulbo_seco_NE_00h_01Fev2012_cropped.pdf} }}%
...
\begin{figure}[t!]
	\centering
\includegraphics[width=0.6\linewidth]{Figuras/signal_ring_graph_white_border.pdf}
...
\subsection{Computation of $\mathbf{A}^{\MakeLowercase{a}}$}\label{subsec:comp}
...
\begin{figure}[b]
	...
	\subfloat[\label{figa_frac_delay_directed}]{{
			\includegraphics[width=0.40\linewidth]{Figuras/d170309_frac_delay_ring_visualization_V5_a.eps}
			}}
	%	\vspace{-0.2cm}
	\subfloat[\label{figb_frac_delay_directed}]{{
			\includegraphics[width=0.40\linewidth]{Figuras/d170309_frac_delay_ring_visualization_V5_b.eps}
			}}\\
	\subfloat[\label{figc_frac_delay_directed}]{{
			\includegraphics[width=0.85\linewidth]{Figuras/d170309_frac_delay_ring_visualization_V5_c1.eps}
			}}% 
...
\begin{figure}[t!]
	\centering
\includegraphics[width=0.95\linewidth]{Figuras/signal_PE_V2_PT.pdf}
...
\begin{figure}[t!]
	...
	\subfloat[\label{figa_gibbs}]{{
			\includegraphics[width=0.8\linewidth]{Figuras/d170309_frac_delay_ring_visualization_V2_no_gibbs.eps}
			}}\\
	%	\vspace{-0.2cm}
	\subfloat[\label{figb_gibbs}]{{
			\includegraphics[width=0.78\linewidth]{Figuras/frac_delay_ring_TESTS_gibbs_effect.eps}
			}}%
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.81\linewidth]{Figuras/convergence_odd_N_V4.pdf}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.81\linewidth]{Figuras/convergence_even_N_real_part.pdf}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.81\linewidth]{Figuras/convergence_even_N_abs_V2.pdf}
...
\subsection{Example: Polynomial Representation of $\mathbf{A}^{\MakeLowercase{a}}$}\label{subsec:num1}
...
\begin{figure}
	\centering
	\includegraphics[width=0.55\linewidth]{access/Figuras/graph_jordan.pdf}
...
\subsection{Example: LS Approximation using $\mathbf{A}^{\MakeLowercase{a}}$}\label{subsec:lsi01}
...
\begin{figure}%
	\centering
\includegraphics[width=\linewidth]{Figuras/GNorm_estacoes_temperatura.pdf}
...
\begin{figure}[ht!]%
	\centering
\includegraphics[width=0.88\linewidth]{Figuras/GNorm_estacoes_GFT_Temperatura.pdf}%\vspace{-0.1cm}
...
\begin{figure}[ht!]
	\centering
\includegraphics[width=0.9\linewidth]{Figuras/ERROR_ordens_fracionarias.pdf}
...
\begin{figure}[t!]
	\centering
\includegraphics[width=0.9\linewidth]{access/Figuras/ERROR_mse_min.pdf}
...
\begin{figure}[t!]
	\centering
\includegraphics[width=0.88\linewidth]{access/Figuras/ERROR_estacoes_resposta_grau10.pdf}%\vspace{-0.4cm}
...
\begin{figure}[t!]
	\centering
\includegraphics[width=0.95\linewidth]{access/Figuras/ERROR_errobar_filtrados.pdf}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{access/Figuras/ribeiro.JPG}}]{Guilherme B. Ribeiro} was born in Brazil and received the B. Sc. degree in Electronic Engineering and the M. Sc. degree in Electrical Engineering both from the Federal University of Pernambuco (UFPE), in 2016 and 2018, respectively. He is currently a doctoral student at UFPE in the field of graph signal processing and his interests also include geometric algebra, data science and data visualization.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{access/Figuras/oliveiraneto}}]{Jos\'e R. de Oliveira Neto} was born in Brazil. He received the B.Sc., M.Sc., and Ph.D. degrees in electrical engineering from the Federal University of Pernambuco (UFPE), Brazil, in 2013, 2015, and 2019, respectively. He is currently an Assistant Professor with the Department of Mechanical Engineering, UFPE. His main research interests include digital signal processing, embedded systems, and hardware implementations.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{access/Figuras/lima}}]{Juliano B. Lima} was born in Brazil where he studied electrical engineering. He received the M.Sc. and Ph.D. degrees in electrical engineering from Federal University of Pernambuco (UFPE), Brazil, in 2004 and 2008, respectively. Since 2015, he has been a research productivity fellow awarded by the Conselho Nacional de Desenvolvimento Cient\'ifico e Tecnol\'ogico. He is currently an Associate Professor of the Department of Electronics and Systems at UFPE. His main research interests are in the field of discrete and number-theoretic transforms, and their applications in digital signal processing, communications and cryptography.
\end{IEEEbiography}
